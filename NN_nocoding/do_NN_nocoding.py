...
TEST_NAME = 'NN_nocoding' #name of this test, used for saving things.
...
def do_model(train_i,test_i):
    ...
    input_dim = 32 #num of features
    elu_alpha = 1.0
    seq = Sequential()

    seq.add(Dense(40, input_shape=(input_dim,), kernel_regularizer=regularizers.l2(0.01)))
    seq.add(Dropout(0.2))
