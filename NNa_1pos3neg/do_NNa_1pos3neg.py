...
REPEATS = range(14) #how many time a k-fold is run. How many averages will I see
TEST_NAME = 'NNa_1pos3neg' #name of this test, used for saving things.
KFOLD = 8 #ca 2900 in test set (split made on 0.14)
...
for i in REPEATS:
    ...
    X_new = random.sample(X_dataneg, 15285)+X_datapos#no need to shuffle, kfold does it.
    y_new = random.sample(y_dataneg, 15285)+y_datapos
