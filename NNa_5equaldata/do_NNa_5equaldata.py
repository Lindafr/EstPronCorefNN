...
TEST_NAME = 'NNa_5equaldata' #name of this test, used for saving things.
...
for i in REPEATS:
    ...
    X_new = random.sample(X_dataneg, 25475)+X_datapos+X_datapos+X_datapos+X_datapos+X_datapos#no need to shuffle, kfold does it.
    y_new = random.sample(y_dataneg, 25475)+y_datapos+y_datapos+y_datapos+y_datapos+y_datapos
