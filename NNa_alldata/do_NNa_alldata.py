...
X_new = X_dataneg+X_datapos#no need to shuffle, kfold does it.
y_new = y_dataneg+y_datapos
...
REPEATS = range(9) #how many time a k-fold is run. How many averages will I see
TEST_NAME = 'NNa_alldata' #name of this test, used for saving things.
KFOLD = 12 #ca 2900 in test set (split made on 0.14)
